...
onMounted(() => {
    if (props.visa.required_documents && props.visa.required_documents.length > 0) {
        requiredDocuments.value = [...props.visa.required_documents];
    } else {
...
const form = useForm({
    country: props.visa.country,
    country_code: props.visa.country_code || '',
    visa_type: props.visa.visa_type || '',
    slug: props.visa.slug,
    description: props.visa.description || '',
    required_documents: [] as string[],
    application_guidelines: props.visa.application_guidelines || '',
    processing_time: props.visa.processing_time || '',
    visa_fee: props.visa.visa_fee,
    currency: props.visa.currency || 'BDT',
    eligibility_criteria: props.visa.eligibility_criteria || '',
    important_notes: props.visa.important_notes || '',
    is_active: props.visa.is_active,
    meta_title: props.visa.meta_title || '',
    meta_description: props.visa.meta_description || '',
    meta_keywords: props.visa.meta_keywords || '',
});

const submit = () => {
    form.required_documents = requiredDocuments.value.filter(doc => doc.trim() !== '');
    form.put(`/cp/visas/${props.visa.id}`, {
        preserveScroll: true,
    });
};
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">Edit Visa Requirement</h1>
                    <p class="text-muted-foreground">Update visa requirement information</p>
                </div>
            ...
            <form @submit.prevent="submit">
                <div class="grid gap-6">
                    ...
                    <div class="flex items-center justify-end gap-4">
                        ...
                        >
                            {{ form.processing ? 'Updating...' : 'Update Visa Requirement' }}
                        </Button>
                    </div>
                </div>
            </form>
